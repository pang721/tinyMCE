...
!function () {
    ...
    var e, t, r, n = tinymce.util.Tools.resolve("tinymce.PluginManager"), p = function () {
        ...
        M = _.DOM, z = function (e) {
            ...
            return k({
                validate: !1, allow_conditional_comments: !0, comment: function (e) {
                    ...
                    if (!m.get()) {
                        if ("video" === e && u) for (var t = 0; t < 2; t++) if (c[U[t]]) {
                            var r = [];
            ...
            return function (e) {
                if (d(e.url) && 0 < e.url.trim().length) {
                    var t = e.html, r = V(a, t), n = p(p({}, r), {source: e.url, embed: t});
                    i.setData(K(n))
                }
            }
        }, Y = function (e, t) {
        ...
        ne = function (a, e) {
            ...
            for (a = o.length; a--;) n = o[a].name, i = o[a].value, "width" !== n && "height" !== n && "style" !== n && ("data" !== n && "src" !== n || (i = e.convertURL(i, n)), r.attr("data-mce-p-" + n, i));
    ...
    !function se() {
        n.add("media", function (e) {
            ...
            return (t = e).addCommand("mceMedia", function () {
                ee(t)
            }), ue(e), e.on("ResolveName", function (e) {
                var t;
                ...
                S.each("webkitallowfullscreen mozallowfullscreen allowfullscreen".split(" "), function (e) {
                    r[e] = {}
                }), d.parser.addNodeFilter("iframe,video,audio,object,embed,script", ce(d)), d.serializer.addAttributeFilter("data-mce-object", function (e, t) {
